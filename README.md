...
- **`@evolonix/react-router-next/vite`** — the `reactRouterNext` Vite plugin (with `routeTypegen` retained as a deprecated alias) and a programmatic `generateRouteTypes` API.
