...
export function CodeBlock({ filename, lang, children }: CodeBlockProps) {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-slate-200 text-sm shadow-sm dark:border-slate-800">
      {filename ? (
      ...
      {html ? (
        <div
          className="shiki-block overflow-x-auto bg-white px-3 py-3 leading-relaxed dark:bg-slate-950"
          dangerouslySetInnerHTML={{ __html: html }}
        />
      ) : (
        <pre className="overflow-x-auto bg-white px-3 py-3 leading-relaxed text-slate-700 dark:bg-slate-950 dark:text-slate-100">
