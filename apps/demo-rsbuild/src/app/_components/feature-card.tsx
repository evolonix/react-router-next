...
export function FeatureCard({
  ...
  return (
    <Link
      to={to}
      className="group focus-visible:ring-brand-500 flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus-visible:ring-2 dark:border-zinc-800 dark:bg-zinc-900"
    >
